...
const aurora = {
    ...
    xp: 0,
    decrire() {
        let description = `${this.nom} a ${this.sante} point(s) de vie, ${this.force} en force et ${this.xp} point(s) d'experience`
        return description;
    },
}
let descriptionAurora = aurora.decrire();
console.log(descriptionAurora)
console.log('=================');

console.log('Aurora apprend une nouvelle compétence');
aurora.xp += 15;
aurora.decrire();
descriptionAurora = aurora.decrire();
console.log(descriptionAurora)
console.log('=================');
